...
if (!query) {
	console.log("Usage: web-search.js <query> [-n <num>] [--content] [--country <code>] [--freshness <period>]");
	console.log("\nOptions:");
	...
	console.log("\nExamples:");
	console.log('  web-search.js "javascript async await"');
	console.log('  web-search.js "rust programming" -n 10');
	console.log('  web-search.js "climate change" --content');
	console.log('  web-search.js "news today" --freshness pd');
	process.exit(1);
}
...
async function fetchSearchResults(query, numResults, country, freshness) {
...
try {
	const results = await fetchSearchResults(query, numResults, country, freshness);
